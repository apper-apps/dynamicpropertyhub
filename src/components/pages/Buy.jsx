...
const Buy = () => {
  ...
  const loadProperties = async () => {
    ...
    try {
      const data = await propertyService.getByType('House');
      // Get all properties, not just houses
        ...
        <div className="container mx-auto px-4 py-16">
          ...
          >
            ...
            <Text size="xl" className="text-white/90 mb-8 max-w-2xl mx-auto">
              Discover the perfect property from our curated selection of premium homes for sale
            </Text>
